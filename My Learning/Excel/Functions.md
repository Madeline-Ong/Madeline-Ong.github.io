...
## Lookup Functions<table>
  ...
  <tr>
    ...
    returns the value from column <i>col_index_num</i> in the row of _lookup_value_.<br>
    If <i>range_lookup</i> is TRUE, the function does an approximate match.<br> If <i>range_lookup</i> is not stated, the function does an exact match.<br> If <i>range_lookup</i> is not stated, the function does an approximate match.</td>
