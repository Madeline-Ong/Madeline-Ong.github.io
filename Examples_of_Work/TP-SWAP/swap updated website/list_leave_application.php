...
<body>
	...
	<div class="container">
		...
		<div class="action">
			<button id='del' class="button">Delete approved/rejected leaves</button>
		</div>
	</div>
	<div id="confirmation_modal" class="modal">
		...
		<div class="modal_content">
			...
			<br>
			<button onclick='window.location.href="delete_approved_rejected_leave.php"' class="button">Yes</button>
	...
	<div class='table_container'>
    	...
    	<table>
			...
			if($_SERVER['REQUEST_METHOD'] == 'POST'){
			    ...
			    $get_all_leave = $con->query('SELECT * FROM leave_application');
			    
			    $count = 1;
			    if ($get_all_leave->num_rows != 0) {
			        while ($row = $get_all_leave->fetch_assoc()){
			            echo '<tr>';
			            echo '<td> ' . $count . '</td>';
